  ...
  >
    ...
    <template #screens>
      ...
      <Screen :title="'Probandeninformation zur Studie “2Step-SI”'" class="instructions"> 
        ...
        <p>Sie  werden  gebeten,  bei körperlichem  oder psychischem Unwohlsein unverzüglich den Versuch abzubrechen. Hierdurch entstehen für Sie keine Nachteile.</p>
        ...
        <p>Studierende  des Bachelorstudiengangs <i>Cognitive  Science</i> erhalten eine Bestätigung  über die Teilnahme an einem psychologischen Experiment im Umfang   von   einer  Versuchspersonenstunde bei Abschluss des Experiments. Diese steht Ihnen zu, sobald Sie mit dem Experiment beginnen, auch  wenn  Sie  das  Experiment  vor  Beendigung  abrechen müssen,  aus  welchen  Gründen  auch immer. Auch steht Ihnen eine Anerkennung von einer Versuchspersonenstunde zu, wenn das Experiment  aus  technischen  oder  anderen  nicht  in  Ihrer  Macht  liegenden  Gründen  nicht beendet   werden   kann. Nehmen Sie in diesem Fall Kontakt mit der Versuchsleitung auf. Eine   finanzielle Aufwandsentschädigung ist für dieses Experiment nicht vorgesehen.</p>
        <br />
        <!-- The $magpie field gives you access to magpie-specific functionality -->
        <button @click="$magpie.nextScreen">Weiter</button>
      </Screen>

      <Screen :title="'Hinweise zur Durchführung dieses Versuchs'" class="instructions"> 
        <strong>Vorschlag von MF:</strong>
        <p>Schalten sie das Experiment auf Fullscreen (wie macht man das?).</p>
        <p>Benutzen Sie eine Maus.</p>
        <p>Schaffen Sie sich Platz für die Mausbewegung. Sie sollten den Mauszeiger in einer Bewegung ohne Abheben der Maus von der unteren zur oberen Bildschirmkannte bewegen können.</p>
        <p>Wenn Sie können, wären wir Ihnen dankbar, wenn Sie die Geschwindigkeit der Maus in Ihren Systemeinstellungen verlangsamen könnten, so dass es Ihnen gerade noch mühelos gelingt, in einer Armbewegung den Mauszeiger von der unteren zur oberen Bildschirmkante zu bewegen.</p>
        <br />
        <!-- The $magpie field gives you access to magpie-specific functionality -->
        <button @click="$magpie.nextScreen">Weiter</button>
      </Screen>
      ...
      <Screen :title="'Instruktionen'" class="instructions">
        ...
        <p>Auch  wenn  das  Experiment  nur  etwa  20  Minuten  dauern  wird,  kann  die  Ihnen gestellte Aufgabe eintönig werden, so dass Sie vielleicht bald das Gefühl haben könnten, mit   Ihren   Reaktionen   »in   einen   Trott«   zu   geraten.   Bitte   achten   Sie   darauf,   Ihre Konzentration   auf   die   Aufgabe   über   den   gesamten   Verlauf   des   Experiments aufrechtzuerhalten! Nutzen Sie gerne die Phasen vor einem Klick auf den Startpunkt, um beispielsweise Ihren Arm neu zu positionieren oder einfach kurz durchzuatmen.</p>
        <br />
        <br />
